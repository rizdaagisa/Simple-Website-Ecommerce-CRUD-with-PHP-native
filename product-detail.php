<?php 
  ...
  $id = $_GET['id'];
  $menu = query("SELECT * FROM product where id_product = $id")[0];
...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="ml-4 btn btn-primary btn-sm">
							login
						</div>
					</div>
				</nav>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<div class="row" style="width: 90%;">
								...
								<div class="col-2">
									<a href="controller/hapus_keranjang.php?id_product=<?= $id?>"><i class="fas fa-trash"></i></a>
								</div>
							</div>
						</div>
					</li>
	...
	<!-- Product Detail -->
	<section class="sec-product-detail bg0 p-t-65 p-b-60" style="margin-top: 60px;">
		<div class="container">
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/<?= $menu['gambar']?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/<?= $menu['gambar']?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?= $menu['gambar']?>">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<form action="" method="post">
										<input type="hidden" value="<?=$_GET['id']?>" name="id_product"> </input>
										<input type="submit" name="tambahkeranjang" value="Add to cart" class="flex-c-m stext-101 mt-lg-5 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
										</input>
									</form>
								</div>
							</div>	
